...
pub const MATERIALS: &[Material] = &[
    Material { name: "Air",         kind: Kind::Fluid,  density: AIR_DENSITY, rgb: 0x0d1014, emissive: 0.0,  variance: 0.15 },
    Material { name: "Bedrock",     kind: Kind::Static, density: 4000.0,      rgb: 0x1a1c22, emissive: 0.0,  variance: 0.25 },
    Material { name: "Stone",       kind: Kind::Static, density: 250.0,       rgb: 0x5f646e, emissive: 0.0,  variance: 0.30 },
    Material { name: "Dirt",        kind: Kind::Powder, density: 160.0,       rgb: 0x4a3728, emissive: 0.0,  variance: 0.35 },
    Material { name: "Sand",        kind: Kind::Powder, density: 150.0,       rgb: 0xd4a95e, emissive: 0.0,  variance: 0.22 },
    Material { name: "Gravel",      kind: Kind::Powder, density: 175.0,       rgb: 0x7c8088, emissive: 0.0,  variance: 0.40 },
    Material { name: "Coal",        kind: Kind::Powder, density: 140.0,       rgb: 0x24262c, emissive: 0.0,  variance: 0.45 },
    Material { name: "Iron ore",    kind: Kind::Powder, density: 185.0,       rgb: 0x8a6a52, emissive: 0.0,  variance: 0.40 },
    Material { name: "Water",       kind: Kind::Fluid,  density: 100.0,       rgb: 0x2b6cb0, emissive: 0.0,  variance: 0.12 },
    Material { name: "Oil",         kind: Kind::Fluid,  density: 80.0,        rgb: 0x231a12, emissive: 0.0,  variance: 0.20 },
    Material { name: "Steam",       kind: Kind::Fluid,  density: 4.0,         rgb: 0xa8b8c4, emissive: 0.0,  variance: 0.25 },
    Material { name: "Smoke",       kind: Kind::Fluid,  density: 6.0,         rgb: 0x2e3138, emissive: 0.0,  variance: 0.35 },
    Material { name: "Molten iron", kind: Kind::Fluid,  density: 190.0,       rgb: 0xff7a24, emissive: 0.55, variance: 0.18 },
    Material { name: "Lava",        kind: Kind::Fluid,  density: 205.0,       rgb: 0xe8431a, emissive: 0.45, variance: 0.22 },
    Material { name: "Iron",        kind: Kind::Static, density: 210.0,       rgb: 0x9aa4b0, emissive: 0.0,  variance: 0.18 },
    Material { name: "Wood",        kind: Kind::Static, density: 155.0,       rgb: 0x6b4a2c, emissive: 0.0,  variance: 0.30 },
];
